  ...
  sections: [
    {
      ...
      body: [
        ...
        {
          type: "paragraph",
          text: "IF YOU DO NOT AGREE TO ANY TERM OR CONDITION SET FORTH IN THIS AGREEMENT, YOU MUST IMMEDIATELY DISCONTINUE USE OF THE PLATFORM. CONTINUED USE OF THE PLATFORM FOLLOWING ANY MODIFICATION TO THIS AGREEMENT SHALL CONSTITUTE YOUR ACCEPTANCE OF SUCH MODIFICATIONS."
        },
        {
          type: "paragraph",
          text: "IMPORTANT NOTICE: IF YOU ARE EXPERIENCING A MEDICAL EMERGENCY, ARE CONSIDERING SELF-HARM, OR POSE A DANGER TO YOURSELF OR OTHERS, YOU MUST IMMEDIATELY CONTACT THE POLICE OR A SUICIDE PREVENTION HELPLINE SUCH AS AASRA (91-22-27546669). THIS PLATFORM IS NOT DESIGNED FOR EMERGENCY INTERVENTION AND CANNOT PROVIDE CRISIS SUPPORT."
        }
      ]
    },
    {
      ...
      body: [
        {
          type: "paragraph",
          text: "For the purposes of this Agreement, the following terms shall have the meanings ascribed to them below:"
        },
        {
          type: "list",
          items: [
    ...
    },
    {
      ...
      body: [
        {
          type: "paragraph",
          text: "By using this Platform, you represent and warrant the following:"
        },
        {
          type: "list",
          items: [
            "You are at least 18 years of age and legally competent to enter into a binding and enforceable contract under the Indian Contract Act, 1872. The Platform shall not be held responsible for any misuse that may occur by virtue of any person, including a minor, accessing the Platform in contravention of this condition.",
            "You are submitting accurate, current, truthful, and complete Registration Data, and you shall maintain and promptly update such information throughout the duration of your use of the Platform.",
            "You are not a resident of any jurisdiction that prohibits the use of services of this nature by law, regulation, treaty, or administrative act.",
            "You are not accessing the Platform through a circumvention of geographic or jurisdictional restrictions.",
            "You do not maintain more than one active account on the Platform. Multiple accounts using different mobile numbers or identities are strictly prohibited."
          ]
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "The right to use this Platform is personal to the Member and is non-transferable. Any Member found to have provided inaccurate, false, or misleading Registration Data shall be subject to immediate suspension or termination of their account without refund."
        }
      ]
    },
    {
      heading: "4. Nature and Scope of Services",
      subSections: [
        {
          heading: "4.1 Platform as an Intermediary",
          body: [
            {
              type: "paragraph",
        ...
        {
          heading: "4.2 Astrological and Spiritual Advisory Services",
          body: [
            {
              type: "paragraph",
              text: "All astrological consultations, predictions, spiritual guidance, and allied services provided through the Platform are intended solely for the purposes of personal insight, entertainment, and general informational reference. Such services are based on the cumulative knowledge, experience, and interpretations of the respective Service Providers and may vary significantly between providers."
            },
            {
              type: "paragraph",
              text: "ASTROLOGICAL CONTENT AND ADVICE DOES NOT CONSTITUTE PROFESSIONAL MEDICAL, LEGAL, FINANCIAL, OR PSYCHOLOGICAL ADVICE AND SHALL NOT BE RELIED UPON AS SUCH. Members are strongly encouraged to seek qualified professional assistance in all medical, legal, financial, and mental health matters."
            }
          ]
        },
        {
          heading: "4.3 Medical and Health-Related Advice",
          body: [
            {
              type: "paragraph",
              text: "The Platform is not intended for the provision of clinical diagnoses, medical recommendations, or guidance regarding medications or treatment protocols. If any Service Provider provides health-related commentary, such commentary is strictly informational and cannot substitute for an in-person examination by a qualified medical professional."
            },
            {
              type: "paragraph",
        ...
        {
          heading: "4.4 Legal and Financial Advice",
          body: [
            {
              type: "paragraph",
        ...
        {
          heading: "4.5 Service Provider Verification",
          body: [
            {
              type: "paragraph",
    ...
    {
      heading: "5. Member Obligations and Prohibited Conduct",
      body: [
        {
          type: "paragraph",
          text: "By registering as a Member and using the Platform, you represent, warrant, and agree to the following:"
        },
        {
          type: "list",
          items: [
            "You shall not post, transmit, upload, or otherwise make available any content that is false, misleading, defamatory, harmful, threatening, abusive, harassing, obscene, vulgar, sexually explicit, racially offensive, or otherwise objectionable, or that encourages conduct constituting a criminal offence or civil liability under applicable law.",
            "You shall not upload or distribute software viruses, Trojan horses, worms, malicious code, or any other material that may compromise the integrity or operation of the Platform or the systems of other users.",
            "You shall not attempt to gain unauthorized access to any portion or feature of the Platform, its networks, servers, or third-party systems connected to the Platform.",
            "You shall not collect, harvest, or misappropriate the personal information of other Members or Service Providers for purposes of unsolicited communications, spam, or any other unauthorised purpose.",
    ...
    {
      heading: "6. Restricted and Prohibited Content",
      subSections: [
        {
          heading: "6.1 Child Safety and Protection",
          body: [
            {
              type: "paragraph",
            ...
            },
            {
              type: "list",
              items: [
                "The creation, uploading, distribution, or possession of child sexual abuse material.",
                "Online grooming or solicitation of minors for sexual contact or exchange of sexual material.",
                "Sexualisation of minors in any form of imagery, text, or communication.",
                "Sextortion or blackmail involving minors.",
                "Any content that appeals to children but contains adult themes, excessive violence, or material that may facilitate harm to minors."
              ]
            },
            {
              type: "paragraph",
              text: "Any user found engaging in such conduct will have their account permanently deleted with immediate effect and the matter will be reported to the appropriate law enforcement authorities. Any such behaviour must be reported immediately to mail@astrotring.com."
            }
          ]
        },
        {
          heading: "6.2 Prohibited Practices -- Black Magic, Witchcraft, and Tantrism",
          body: [
            {
              type: "paragraph",
            ...
            {
              type: "paragraph",
              text: "Any such activity must be reported immediately to mail@astrotring.com."
            }
          ]
        },
        {
          heading: "6.3 Sexual Content and Profanity",
          body: [
            {
              type: "paragraph",
              text: "The Platform does not permit any content that is sexually explicit, pornographic, or designed to solicit sexual acts for compensation. Prohibited content includes, without limitation, depictions of sexual nudity, sexual acts, non-consensual intimate imagery, and content that objectifies, degrades, or exploits individuals. Accounts found to violate this policy will be deleted with immediate effect."
            }
          ]
        },
        {
          heading: "6.4 Hate Speech, Violence, and Terrorism",
          body: [
            {
              type: "paragraph",
              text: "The Platform prohibits content that promotes, glorifies, incites, or facilitates violence, hatred, discrimination, or terrorism. Users may not publish, share, or promote content related to terrorist organisations, dangerous movements, gratuitous violence, threats, or hate speech directed at any individual or group based on race, religion, caste, national origin, gender, sexual orientation, disability, or any other protected characteristic."
            }
          ]
        },
        {
          heading: "6.5 Dangerous Products and Substances",
          body: [
            {
              type: "paragraph",
              text: "Users may not use the Platform to facilitate the sale, purchase, or promotion of explosives, firearms, ammunition, restricted firearm accessories, marijuana or marijuana-derived products, tobacco products, psychotropic substances, or any drugs falling under restricted categories pursuant to the Drugs and Cosmetics Act, 1940 and the rules made thereunder. The Platform additionally prohibits the posting of instructions for the manufacture of weapons or the conversion of firearms."
            }
          ]
        }
      ]
    ...
    {
      heading: "7. Fees, Payment, and Service Credits",
      subSections: [
        {
          heading: "7.1 Payment Obligations",
          body: [
            {
              type: "paragraph",
              text: "Members are solely responsible for all fees incurred in connection with their use of the Platform, including all Transactions occurring under their account. All payment information provided by a Member must be accurate, current, and complete, and the Member must be the lawful and authorised owner of the payment instrument used."
            },
            {
              type: "paragraph",
        ...
        },
        {
          ...
          body: [
            ...
            {
              type: "paragraph",
              text: "Service Credits shall be of two types:"
            },
            {
              type: "list",
              items: [
                "\"Real Service Credits\" -- acquired by a Member through direct monetary payment via authorised payment methods on the Platform.",
                "\"Virtual Service Credits\" -- credited to a Member's Wallet without monetary payment, including promotional credits, cashback, referral rewards, bonus credits, or similar non-cash credits."
              ]
            },
            {
              type: "paragraph",
              text: "Service Credits have no cash value, do not represent money or monetary value, and are non-transferable, non-assignable, non-redeemable, and cannot be withdrawn, encashed, or exchanged for cash or cash equivalents."
            }
          ]
        },
        {
          heading: "7.3 Validity and Expiry of Service Credits",
          body: [
            {
              type: "paragraph",
              text: "All Service Credits are issued with a defined validity period. Virtual Service Credits shall expire fourteen (14) days from the date of credit, unless a different expiry period is expressly communicated at the time of credit. Real Service Credits shall expire in accordance with the validity period specified at the time of credit (generally up to one year)."
            },
            {
              type: "paragraph",
            ...
            {
              type: "paragraph",
              text: "Any dispute relating to Service Credits or their expiry must be raised within thirty (30) days from the date of such expiry, failing which the right to dispute shall be deemed waived, subject to applicable law."
            }
          ]
        },
        {
          heading: "7.4 Order of Utilisation",
          body: [
            {
              type: "paragraph",
              text: "Where a Member's Wallet contains multiple Service Credits from different sources or with different validity periods, such credits shall be utilised proportionately in the ratio of their respective available balances at the time of utilisation, unless expressly stated otherwise at the time of credit. Virtual Service Credits and Real Service Credits shall be consumed simultaneously on a pro-rata basis."
            }
          ]
        }
      ]
    ...
    {
      heading: "8. Refund and Cancellation Policy",
      body: [
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "Refunds will only be considered in the following circumstances:"
        },
        {
          type: "list",
          items: [
            "Network or technical disruption during a chat or call session, including weak signal, background noise, or inaudible audio.",
            "The Service Provider is unable to communicate fluently in the language stated in their profile.",
            "The Service Provider takes an unreasonably long time to respond.",
            "The Service Provider's response is irrelevant or inappropriate to the Member's query."
          ]
        }
      ]
    },
    {
      heading: "9. User Account, Username, and Password Security",
      body: [
        {
          type: "paragraph",
          text: "Each Member is responsible for maintaining the confidentiality of their account credentials, including their username, password, and any associated security information. Members are solely and fully liable for all activities, postings, Transactions, and communications that occur under their account."
        },
        {
          type: "paragraph",
    ...
    {
      heading: "11. Third-Party Links, Websites, and Services",
      body: [
        {
          type: "paragraph",
    ...
    {
      heading: "13. Legal Requirement to Disclose Information",
      body: [
        {
          type: "paragraph",
    ...
    {
      heading: "14. Copyright Infringement Policy",
      body: [
        {
          type: "paragraph",
        ...
        },
        {
          ...
          items: [
            ...
            "A description of the copyrighted work claimed to have been infringed, including the URL of the original work if applicable;",
            "A description of the location on the Platform of the allegedly infringing material, including the relevant URL;",
    ...
    },
    {
      ...
      body: [
        {
          type: "paragraph",
          text: "THE PLATFORM AND ALL SERVICES, CONTENT, AND MATERIALS MADE AVAILABLE THROUGH THE PLATFORM ARE PROVIDED ON AN \"AS IS\" AND \"AS AVAILABLE\" BASIS WITHOUT ANY WARRANTY OF ANY KIND, WHETHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING IMPLIED WARRANTIES OF TITLE, NON-INFRINGEMENT, MERCHANTABILITY, OR FITNESS FOR A PARTICULAR PURPOSE."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "This Section shall survive the termination or expiration of this Agreement."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      body: [
        ...
        },
        {
          type: "list",
          items: [
            "Any breach of any representation, warranty, covenant, or obligation set forth in this Agreement;",
            "The Member's refusal or failure to pay for services rendered by a Service Provider;",
            "Any content submitted, posted, or transmitted by the Member through the Platform;",
            "The Member's use of the Platform in violation of applicable law or the rights of any third party;",
            "Any misuse of the Platform or its services."
          ]
        },
        {
          type: "paragraph",
    ...
    {
      heading: "18. Use of Display Names by Service Providers",
      body: [
        {
          type: "paragraph",
    ...
    {
      heading: "19. Modification and Termination of Services",
      body: [
        {
          type: "paragraph",
    ...
    {
      heading: "20. Governing Law, Dispute Resolution, and Jurisdiction",
      body: [
        {
          type: "paragraph",
          text: "This Agreement shall be governed by and construed in accordance with the laws of India, excluding any conflict of law principles. Any dispute, controversy, or claim arising out of or in connection with this Agreement, including any question regarding its existence, validity, breach, or termination, shall be referred to and finally resolved by arbitration under the Arbitration and Conciliation Act, 1996, before a sole arbitrator mutually agreed upon by the parties."
        },
        {
          type: "paragraph",
          text: "Arbitration proceedings shall be conducted in the English language in New Delhi, India. The decision and award of the arbitrator shall be final and binding upon both parties. Notwithstanding the foregoing, either party may seek interim or emergency injunctive relief from a court of competent jurisdiction in New Delhi to preserve its rights pending the outcome of arbitration."
        },
        {
          type: "paragraph",
          text: "For all other legal proceedings, the parties hereby submit to the exclusive jurisdiction of the courts located in New Delhi, India."
        }
      ]
    },
    {
      ...
      body: [
        ...
        {
          type: "paragraph",
          text: "Severability: If any provision of this Agreement is held to be invalid, illegal, or unenforceable by a court of competent jurisdiction, such provision shall be deemed modified to the minimum extent necessary to make it enforceable, and the remaining provisions of this Agreement shall continue in full force and effect."
        },
        {
          type: "paragraph",
        ...
        {
          type: "paragraph",
          text: "Paragraph Headings: The headings in this Agreement are included for convenience only and shall not affect the interpretation of any provision."
        },
        {
          type: "paragraph",
