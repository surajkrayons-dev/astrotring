...
import { astrologerServiceProviderTermsAndConditionsdata } from '@/data/allPolicyData/astrologerServiceProviderTermsAndConditionsdata';
import React from 'react';
import { Link } from 'react-router-dom';

const AstrologerServiceProviderTermsAndConditionsPage = () => {
  const { name, website, title, lastUpdated, sections } = astrologerServiceProviderTermsAndConditionsdata;
         ...
         <div className="mt-6 pt-6 border-t border-stone-400">
                    ...
                    <div className="space-y-4 text-stone-600 text-sm leading-relaxed">
                        <p className="text-justify">
                            BY REGISTERING AS A SERVICE PROVIDER ON THE PLATFORM OR BY CONTINUING TO USE THE PLATFORM, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND UNCONDITIONALLY AGREE TO BE LEGALLY BOUND BY ALL TERMS AND CONDITIONS SET FORTH IN THIS AGREEMENT. IF YOU DO NOT AGREE TO ANY PROVISION OF THIS AGREEMENT, YOU MUST NOT REGISTER AS A SERVICE PROVIDER AND MUST IMMEDIATELY CEASE USE OF THE PLATFORM.
                        </p>
                    </div>
                </div>
      </div>
...
export default AstrologerServiceProviderTermsAndConditionsPage;